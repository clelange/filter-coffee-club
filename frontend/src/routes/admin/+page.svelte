...
{:else if activeTab==='equipment'}
  <div class="equipment-grid"><form class="panel" onsubmit={addGrinder}><h2>Grinder</h2><label>Manufacturer<input bind:value={grinderForm.manufacturer} required /></label><label>Model<input bind:value={grinderForm.model} required /></label><div class="field-grid"><label>Unit<input bind:value={grinderForm.setting_unit} required /></label><label>Step<input type="number" bind:value={grinderForm.setting_step} min="0.01" step="0.01" /></label><label>Soft min<input type="number" bind:value={grinderForm.soft_min} /></label><label>Soft max<input type="number" bind:value={grinderForm.soft_max} /></label></div><label>Guidance<textarea bind:value={grinderForm.guidance}></textarea></label><button class="primary">Add grinder</button></form>
